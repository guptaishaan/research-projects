...
\papertitle{The Control Is the Instrument: Calibrating Perturbation\\
Tests Used to Prove That EEG Decoders Read the Brain}

\renewcommand{\thefootnote}{\fnsymbol{footnote}}
\paperauthors{Srikanth Samy\footnotemark[1]\affil{1}\ \ and
Ishaan Gupta\footnotemark[2]\affil{2}}
\footnotetext[1]{\texttt{ssamy@berkeley.edu}}
\footnotetext[2]{\texttt{ishaangupta@stanford.edu}}
\renewcommand{\thefootnote}{\arabic{footnote}}\setcounter{footnote}{0}

\paperaffils{\affil{1}University of California, Berkeley\\
